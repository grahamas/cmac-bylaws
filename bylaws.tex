...
shall be called by the Treasurer. If the Board, or possibly
the aforementioned special election, selects a current member of the
Board, the fifth vote on the board will be granted to a
...
the year among the remainder of the Board, the President shall
...
If the Board should find itself with four or fewer Officers
